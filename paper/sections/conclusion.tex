...
The highest-priority extensions are harder higher-powered benchmark variants that preserve score headroom, direction-aware analysis metrics for saturated targets, and multi-artifact coordinated mutations that lift the current single-file scope (\cref{sec:future-work}).
