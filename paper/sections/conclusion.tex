...
The archived treatment configuration produces a directional improvement on final-score over control on every target, ranging from $+3.5\%$ to $+44.5\%$, with mean cost in the same range under the recorded model-routing setup.
