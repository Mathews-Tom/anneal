...
The two strongest greedy-versus-treatment comparisons (B3, B5) sit at the Wilcoxon two-sided $p$-value floor for $n = 5$, indicating that the binding constraint is statistical power rather than effect magnitude.
