...
\emph{Val} column marks mechanism-level validation in \cref{sec:results}:
$\checkmark$ indicates the component is one of the three mechanisms tested
against an analytically known ground truth; a dash indicates the component
is argued from design and awaits end-to-end empirical validation as future
work.}
\label{tab:enhancements}
\small
\begin{tabular}{@{}lllp{5.0cm}c@{}}
\toprule
...
Episodic Memory (TF-IDF retrieval) & Knowledge & Structured Lesson extraction + TF-IDF / sentence-embedding similarity retrieval & Avoids repeating failed approaches; transfers successful patterns; retrieval precision validated in \cref{sec:gate-retrieval} & $\checkmark$ \\
