...
\begin{enumerate}
  ...
  \item \textbf{Structured episodic knowledge retrieval} (\cref{sec:gate-retrieval}).
    ...
    The isolated validation in this paper targets retrieval precision; on a controlled similarity corpus, TF-IDF retrieval achieves $1.55\times$ the precision of Jaccard similarity.
\end{enumerate}
