...
The directional pattern across targets and the two strongest B3/B5 greedy-versus-treatment comparisons identify where a higher-powered replication looked most informative before considering target saturation; \cref{sec:threats} discusses why follow-up work should use harder variants rather than only more seeds on the same tasks.
