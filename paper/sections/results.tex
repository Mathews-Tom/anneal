...
The mechanism-level results in this section therefore do not exercise the raw, greedy, control, and treatment vocabulary of \cref{sec:benchmark-suite}; baselines here are method-specific (uncorrected sequential testing, fixed-schedule simulated annealing, Jaccard set similarity).
